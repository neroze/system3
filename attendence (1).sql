...
--
-- Host: localhost
-- Generation Time: Aug 08, 2013 at 01:09 PM
...
INSERT INTO `aus` (`a_id`, `astate`) VALUES
(1, ' New South Wales'),
(2, ' Victoria'),
(3, ' Queensland'),
(4, ' Western Australia'),
...
(1, 'Rojan', 'Thapa', 'psyco_rozan@yahoo.com', 0, 0, '0', '0', '0', 'nepal', '0', '2013-07-10'),
(2, 'dadad', 'Thapa', 'atulkarki_2009@yahoo.com', 2147483647, 788, '0', '0', '0', 'nepal', '0', '2013-07-10'),
(18, 'cerce', 'Thapa', 'crackrozan@gmail.com', 2147483647, 545, '0', '0', '0', 'nepal', '0', '2013-07-11'),
(19, 'Hira', 'singh', 'lal@yahoo.com', 2147483647, 445, '0', '0', '0', 'NEpal', '0', '2013-07-03'),
(20, 'Dinesh', 'Karki', 'dinesh@3hammers.com', 5527791, 977, '0', '0', '0', 'Nepal', '0', '2013-07-03');
...
(209, 32323, '2013-08-06', 1),
(212, 32323, '2013-08-13', 67),
(213, 32323, '2013-08-05', 2);
...
(1, 'let me know', 3, 'pending', 1),
(5, 'world is not fair', 4, 'pending', 1);
...
(1, '\0\0', 'administrator', '59beecdf7fc966e2f17fd8f65a4a9aeb09d4a3d4', '9462e8eee0', 'rojan@admin.com', '', NULL, NULL, '9d029802e28cd9c768e8e62277c0df49ec65c48c', 1268889823, 1375939760, 1, 'Rojan', 'thapa', 'ADMIN', '0');
...
--
ALTER TABLE `payment`
  ADD CONSTRAINT `payment_ibfk_3` FOREIGN KEY (`pro_id`) REFERENCES `project` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `project`
--
ALTER TABLE `project`
  ADD CONSTRAINT `project_ibfk_3` FOREIGN KEY (`cl_id`) REFERENCES `client` (`c_id`) ON DELETE CASCADE ON UPDATE CASCADE;
