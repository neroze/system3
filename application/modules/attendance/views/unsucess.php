...
<html lang="en">
    ...
    <div class="container">
       		 <div class="span10" href style="margin-left:250px;margin-top: 50px;">
            
           
                <?php
               
               echo "<h1> SORRY BRO NO MATCH FOUND</h1>";
                ?> 
           

                     <a href="http://localhost/attendence_system/index.php/Homecontroller"><h4>Back to Home</h4> </a>
